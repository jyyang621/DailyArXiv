...
keywords = ["RAG", "Agent", "SFT", "RLHF", "LLM", "Function Call", "LLM Tabular"]  # TODO add more keywords
...
f_is.write("---\n")
f_is.write("**Please check the [Github](https://github.com/jyyang621/DailyArXiv/) page for a better reading experience and more papers.**\n\n")
